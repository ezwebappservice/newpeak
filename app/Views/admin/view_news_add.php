				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="news_slug" maxlength="255" placeholder="Auto-generated from title if empty" value="<?php if(isset($_POST['news_slug'])) {echo esc($_POST['news_slug']);} ?>">
								<p class="help-block">Optional. Used in URL: latest-news/your-slug</p>
							</div>
						</div>
						<div class="form-group">
