...
<div class="login-box">
	<div class="login-logo">
  	...
  	<div class="login-box-body">
    	<p class="login-box-msg">Enter your email to receive reset instructions</p>
		...
		<?php echo form_open(base_url().'admin/forget-password');?>
			...
			<div class="row">
				<div class="col-xs-7" style="padding-top:10px;"><a href="<?php echo base_url(); ?>admin/login" style="color:var(--srl-teal);font-weight:500;">Back to sign in</a></div>
				<div class="col-xs-5">
					<input type="submit" class="btn btn-primary btn-block btn-flat login-button" name="form1" value="Send Link">
				</div>
			</div>
		<?php echo form_close(); ?>
	</div>
