	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="callout callout-info">
				<p class="mb-0">These images rotate behind the homepage hero. Only the <strong>photo</strong> is shown on the site — heading and button fields are kept for legacy data and are not displayed on the current homepage design.</p>
			</div>
					...
					<table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th>Button2 Text</th>
								<th>Button2 URL</th>
								<th>Position</th><th width="140">Action</th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							foreach ($slider as $row) {
								...
								<tr>
									...
									<td><?php echo $row['position']; ?></td><td>										
