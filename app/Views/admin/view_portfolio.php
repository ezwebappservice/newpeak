					...
					<table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th>Name</th>
								<th>Category</th>
								<th>Photo</th><th width="140">Action</th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							foreach ($portfolio as $row) {
								...
								<tr>
									...
									<td style="width:250px;"><img src="<?php echo base_url(); ?>public/uploads/<?php echo $row['photo']; ?>" alt="<?php echo $row['name']; ?>" style="width:150px;"></td><td>
			                                ...
			                                <div class="modal-body">
			                                    <div class="rTable">
			                                        ...
			                                        <div class="rTableRow">
			                                            ...
			                                            <div class="rTableCell">
			                                                <?php
			                                                $all_photos = $Model_portfolio->get_all_photos_by_category_id($row['id']);
