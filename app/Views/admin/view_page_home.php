...
$sectionToggles = [
    ...
    [
        'title'  => 'Counter Stats (in Why Choose Us)',
        'field'  => 'counter_status',
        'form'   => 'form_home_counter_text',
        'hint'   => 'Counter values are edited under Edit (also used in Hero stats).',
    ],
    [
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="callout callout-info">
                <p class="mb-0">Manage homepage section visibility and headings here. Section content (products, news, team, etc.) is managed from the matching modules in the admin sidebar.</p>
            </div>
