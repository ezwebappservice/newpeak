				...
				<div class="box box-info">
					<div class="box-body">						
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="icon" value="<?php echo esc($service['icon'] ?? ''); ?>" placeholder="bi bi-capsule">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Link URL / Text</label>
							<div class="col-sm-4">
								<input type="text" autocomplete="off" class="form-control" name="link_url" value="<?php echo esc($service['link_url'] ?? ''); ?>">
							</div>
							<div class="col-sm-4">
								<input type="text" autocomplete="off" class="form-control" name="link_text" value="<?php echo esc($service['link_text'] ?? ''); ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6" style="padding-top:5px">
								<input type="file" name="photo">(Optional; jpg, jpeg, gif, png)
							</div>
						</div>
