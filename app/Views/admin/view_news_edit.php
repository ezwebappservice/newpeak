				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="news_slug" maxlength="255" value="<?php echo esc($news['news_slug'] ?? ''); ?>">
								<p class="help-block">URL: <?php echo news_url($news['news_slug'] ?? ''); ?></p>
							</div>
						</div>
						<div class="form-group">
