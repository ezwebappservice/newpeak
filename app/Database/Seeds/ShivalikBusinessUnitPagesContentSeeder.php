...
use Config\ShivalikBusinessUnitPageContent;
use Config\ShivalikPages;

class ShivalikBusinessUnitPagesContentSeeder extends Seeder
{
    public function run()
    {
        $pages = config(ShivalikBusinessUnitPageContent::class)->pages;
        $banners = config(ShivalikBusinessUnitPageContent::class)->banners;
        ...
        echo 'Business unit pages: updated ' . $updated . ', created ' . $created . ' (lang_id=' . $langId . ').' . PHP_EOL;
    }
}
