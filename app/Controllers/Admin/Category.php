...
class Category extends BaseController 
{
	public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger) 
	{
        ...
        $this->Model_category = new \App\Models\Admin\Model_category();
    }
	...
	public function index()
	{
		...
		echo view('admin/view_category',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
            ...
            echo view('admin/view_header',$data);
			echo view('admin/view_category_add',$data);
			echo view('admin/view_footer');
        }
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    if($valid == 1) 
		    {
		    	...
		    	if($path == '') {
					...
					safe_unlink_upload($data['category']['category_banner']);
			...
			$data['category'] = $this->Model_category->get_category($id);
	       	echo view('admin/view_header',$data);
			echo view('admin/view_category_edit',$data);
			echo view('admin/view_footer');
		}
	...
	public function delete($id) 
	{
    	...
    	else
    	{
			...
			safe_unlink_upload($category['category_banner']);
