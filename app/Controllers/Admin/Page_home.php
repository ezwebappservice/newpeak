...
class Page_home extends BaseController 
{
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
			...
			$hero_title_suffix = $this->request->getPost('hero_title_suffix', true);
			$hero_feature_1_title = $this->request->getPost('hero_feature_1_title', true);
			$hero_feature_2_title = $this->request->getPost('hero_feature_2_title', true);
			$hero_feature_3_title = $this->request->getPost('hero_feature_3_title', true);
			$hero_card_name = $this->request->getPost('hero_card_name', true);
			$hero_card_role = $this->request->getPost('hero_card_role', true);
			$hero_card_org = $this->request->getPost('hero_card_org', true);
			$hero_card_badge = $this->request->getPost('hero_card_badge', true);
			$hero_tab_text = $this->request->getPost('hero_tab_text', true);
		    ...
		    if($valid == 1) 
		    {
	    		...
	    		$form_data = array(
					...
					'hero_title_suffix' => $hero_title_suffix,
					...
					'hero_card_name' => $hero_card_name,
					'hero_card_role' => $hero_card_role,
					'hero_card_org' => $hero_card_org,
					'hero_card_badge' => $hero_card_badge,
					'hero_tab_text' => $hero_tab_text,
