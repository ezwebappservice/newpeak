...
class Lang extends BaseController 
{
	public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger) 
	{
        ...
        $this->Model_lang = new \App\Models\Admin\Model_lang();
    }
	...
	public function index()
	{
		...
		echo view('admin/view_lang',$data);
	...
	public function add()
	{
		...
		$lang_name = $this->request->getPost('lang_name', true);
		$lang_short_name = $this->request->getPost('lang_short_name', true);
		$layout_direction = $this->request->getPost('layout_direction', true);
		$lang_default = $this->request->getPost('lang_default', true);
		...
		if(isset($_POST['form1'])) {
            ...
            echo view('admin/view_header',$data);
			echo view('admin/view_lang_add',$data);
			echo view('admin/view_footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
			...
			$data['lang'] = $this->Model_lang->getData($id);
	       	echo view('admin/view_header',$data);
			echo view('admin/view_lang_edit',$data);
			echo view('admin/view_footer');
		}
    ...
    public function detail($id)
    {
		...
		else
		{
			...
			$data['id'] = $id;
			echo view('admin/view_header',$data);
			echo view('admin/view_lang_detail',$data);
			echo view('admin/view_footer');	
		}
