...
class File extends BaseController 
{
	public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger) 
	{
        ...
        $this->Model_file = new \App\Models\Admin\Model_file();
    }
	...
	public function index()
	{
		...
		echo view('admin/view_file',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
            ...
            echo view('admin/view_header',$data);
			echo view('admin/view_file_add',$data);
			echo view('admin/view_footer');
        }
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    if($valid == 1) 
		    {
		    	...
		    	if($path == '') {
					...
					safe_unlink_upload($data['file']['photo']);
			...
			$data['file'] = $this->Model_file->get_file($id);
	       	echo view('admin/view_header',$data);
			echo view('admin/view_file_edit',$data);
			echo view('admin/view_footer');
		}
	...
	public function delete($id) 
	{
        ...
        $data['file'] = $this->Model_file->get_file($id);
        if($data['file']) {
            safe_unlink_upload($data['file']['file_name']);
        }
