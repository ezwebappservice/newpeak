...
class Team_member extends BaseController 
{
	public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger) 
	{
        parent::initController($request, $response, $logger);
        $this->Model_common = new \App\Models\Admin\Model_common();
        $this->Model_team_member = new \App\Models\Admin\Model_team_member();
    }
	...
	public function index()
	{
		...
		echo view('admin/view_team_member',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
				...
				$destination = upload_file_path($final_name);
				$new_width = 400;
			  	$new_height = 400;
			 	$quality = 100;
            ...
            echo view('admin/view_header',$data);
			echo view('admin/view_team_member_add',$data);
			echo view('admin/view_footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    if($valid == 1) 
		    {
		    	...
		    	{
		    		safe_unlink_upload($_POST['current_photo']);
			...
			$data['team_member'] = $this->Model_team_member->get_team_member($id);
            echo view('admin/view_header',$data);
			echo view('admin/view_team_member_edit',$data);
			echo view('admin/view_footer');
		}
	...
	public function delete($id) 
	{
        ...
        $data['team_member'] = $this->Model_team_member->get_team_member($id);
        if($data['team_member']) {
            safe_unlink_upload($data['team_member']['photo']);
        }
